...
#define PAT_PATH_CSP_EXPLORE_DIR homeDir + "/catkin_ws/src/3806ict_assignment_3/pat/validator.csp"
// path to the return home path csp file for PAT
#define PAT_PATH_CSP_HOME_DIR homeDir + "/catkin_ws/src/3806ict_assignment_3/pat/validator.csp"
// path to the collect survivors path csp file for PAT
#define PAT_PATH_CSP_COLLECT_SURVIVORS_DIR homeDir + "/catkin_ws/src/3806ict_assignment_3/pat/validator.csp"
...
void generate_world(int (&world)[BOARD_H][BOARD_W])
{
	...
	// place submarine randomly
	int sub_row, sub_col;
	do {
		sub_row = rowDist(gen);
		sub_col = colDist(gen);
	} while (world[sub_row][sub_col] != EMPTY);
	world[sub_row][sub_col] = SUB;
